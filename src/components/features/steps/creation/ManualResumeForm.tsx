...
import { User, Mail, Award, Briefcase, GraduationCap, Target, FileText, Sparkles, ArrowRight } from 'lucide-react'
...
export const ManualResumeForm: React.FC<ManualResumeFormProps> = ({
  onResumeGenerated,
  isGenerating,
  selectedTemplate,
  editingResume
      ...
      for (const template of templates) {
        try {
          ...
          variants.push({
            ...
            preview: formData.summary || `AI-generated ${template} resume highlighting achievements and experience`,
            // Database fields
  ...
  return (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h3 className="text-2xl font-bold text-white mb-2">Manual Resume Creation</h3>
        <p className="text-gray-300">Fill in your information step by step</p>
      </div>
