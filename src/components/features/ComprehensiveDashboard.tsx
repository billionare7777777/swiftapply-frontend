          ...
          <div className="relative group">
            ...
            <div className="relative p-12 text-center">
              ...
              <p className="text-gray-300 mb-6">
                {isConnectionError 
                  ? 'Unable to connect to the backend server. Please make sure the backend server is running on http://localhost:5000.'
              ...
              {isConnectionError && (
                <div className="mb-6 p-4 bg-yellow-500/20 rounded-xl border border-yellow-500/30">
                  <p className="text-yellow-200 text-sm">
                    ...
                    3. Wait for "Running on http://localhost:5000" message
                  </p>
                </div>
              )}
              <button
